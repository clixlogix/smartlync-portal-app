...
export const messages = {
    ...
    reportThresholdLabel: _t(translations.Filters.FilterByReportThresholdLabel, 'Report Threshold'),
    ...
    reportThresholdPlaceholder: _t(translations.Filters.FilterByReportThresholdPlaceholder, 'Select Report Threshold'),
};
