...
export const messages = {
    // labels
    faultCodeLabel: _t(translations.Filters.FilterByFaultCodeLabel, 'Event Code'),
    ...
    selectFaultCode: _t(translations.ReportingViewPage.SelectFaultCode, 'Select Fault #:'),
    filterByStudType: _t(translations.ReportingViewPage.FilterByStudType, 'Filter By Stud Type'),
    filterByDeviceName: _t(translations.ReportingViewPage.FilterByDeviceName, 'Filter By Device'),
    filterByStudID: _t(translations.ReportingViewPage.FilterByStudID, 'Filter By Stud ID'),
};
