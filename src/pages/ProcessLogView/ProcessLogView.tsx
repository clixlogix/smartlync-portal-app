...
import { ProcessLogProperty } from 'widgets/ProcessLog';
...
//import { ExtraData } from 'widgets/StationAnomaly/ExtraData/ExtraData';
import { Pages } from 'constants/defaultDateConfig';
import './ProcessLogView.scss';
...
interface ProcessLogViewProps extends PageProps { }

const listOfLocalFilters = [];

export const ProcessLogView: Page<ProcessLogViewProps> = memo((props: ProcessLogViewProps) => {
    ...
    const pageFilters = useMemo(() => {
        ...
        return [
            ...
            ...(ProcessLogProperty.defaultFilters || []),
        ];
    }, []);
    ...
    return (
        <>
            <Helmet>
                <title>{t(messages.processLogViewPageTitle)}</title>
