...
export const messages = {
    reportingViewSprPageTitle: _t(translations.ReportingViewSpr.PageTitle, 'ReportingViewSpr '), // default value
    reportingViewSprTitle: _t(translations.ReportingViewSpr.Title, 'ReportingViewSpr '), // default value
    ...
    expandTooltip: _t(translations.ReportingViewPageB.ExpandTooltip, 'Show \n Events Cycle Ratio etc.'),
    collapeTooltip: _t(translations.ReportingViewPageB.CollapeTooltip, 'Hide \n Events Cycle Ratio etc.'),
