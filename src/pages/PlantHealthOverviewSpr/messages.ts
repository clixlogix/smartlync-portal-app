...
export const messages = {
    plantHealthOverviewSprPageTitle: _t(translations.PlantHealthOverviewSpr.PageTitle, 'PlantHealthOverviewSpr '), // default value
    plantHealthOverviewSprTitle: _t(translations.PlantHealthOverviewSpr.Title, 'PlantHealthOverviewSpr '), // default value
