...
import { selectEventDescFrequencySprFilterValues } from 'services/event-desc-frequency-spr/event-desc-frequency-spr-selectors';
...
import DurationOfFaultsSpr from 'widgets/EventFrequencySpr/DurationOfFaultsSpr';
import { EventCodeFrequencySpr } from 'widgets/EventFrequencySpr/EventCodeFrequencySpr/Loadable';
import { EventDescFrequencySpr } from 'widgets/EventFrequencySpr/EventDescFrequencySpr/Loadable';
...
import './ParetoAnalysisSpr.scss';

interface ParetoAnalysisSprProps extends PageProps { }
...
export const ParetoAnalysisSpr: Page<ParetoAnalysisSprProps> = memo((_props: ParetoAnalysisSprProps) => {
    ...
    return (
        <>
            <Helmet>
                <title>{t(messages.paretoAnalysisSprPageTitle)}</title>
            ...
            {availableFilters.length > 0 && (
                <DashboardFilterPanel
                    ...
                    filterValues={() => {
                        ...
                        return useSelector(selectEventDescFrequencySprFilterValues);
                    }}
                />
            )}
            <div className="x-cls-pareto-analysis-spr-body">
                ...
                >
                    <div
                        className="maximize-pareto-spr-widget-width"
                    ...
                    >
                        <DurationOfFaultsSpr
                            className="DurationOfFaultsSpr"
                            filters={filters}
                            localFilters={localFilters}
                            isLoading={(loading: boolean) => updateLoadingState('DurationOfFaultsSprWidget', loading)}
                        />
                    </div>
                    <div
                        className="maximize-pareto-spr-widget-width"
