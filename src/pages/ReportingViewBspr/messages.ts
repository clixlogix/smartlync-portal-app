...
export const messages = {
    pageTitle: _t(translations.ReportingViewPageB.PageTitle, 'Reporting view B'),
    reportingViewBsprPageTitle: _t(translations.ReportingViewBspr.PageTitle, 'ReportingViewBspr '), // default value
    reportingViewBsprTitle: _t(translations.ReportingViewBspr.Title, 'ReportingViewBspr '), // default value
    ...
    faultCode: _t(translations.General.faultCode, 'faultCode'),
};
