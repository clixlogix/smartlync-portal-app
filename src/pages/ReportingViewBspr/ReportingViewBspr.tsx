...
import {
    reportingViewBsprActions,
    reportingViewBsprReducer,
    reportingViewBsprKey,
} from 'services/SPR/reporting-view-bspr/reporting-view-bspr-reducer';
import {
    selectReportingViewBsprs,
    selectReportingViewBsprIsLoading,
} from 'services/SPR/reporting-view-bspr/reporting-view-bspr-selectors';

import { getAllReportingViewBsprsSaga } from 'services/SPR/reporting-view-bspr/sagas/reporting-view-bspr-saga-get-all';
...
interface ReportingViewBsprProps extends PageProps {}
...
export const ReportingViewBspr: Page<ReportingViewBsprProps> = memo((props: ReportingViewBsprProps) => {
    // useInjectReducer({ key: faultCountsKey, reducer: faultCountsReducer });
    // useInjectSaga({ key: faultCountsKey, saga: faultCountsSaga });

    useInjectReducer({ key: reportingViewBsprKey, reducer: reportingViewBsprReducer });
    useInjectSaga({ key: reportingViewBsprKey, saga: getAllReportingViewBsprsSaga });
    ...
    const faultCounts: ReportingViewBsprs = useSelector(selectReportingViewBsprs);
    const faultCountsIsLoading: boolean = useSelector(selectReportingViewBsprIsLoading);
    ...
    useEffect(() => {
        ...
        console.log('🚀 ~ file: ReportingViewBspr.tsx ~ line 178 ~ useEffect ~ weekDayNo', weekDayNo);
        dispatch(
            reportingViewBsprActions.getAllReportingViewBsprs({
                eventCode: faultCode,
                ...apiFilters,
    ...
    return (
        <Div className="x-cls-reporting-view-bspr-container">
