...
import { selectEventCountDailyFrequencFilterValues } from 'services/event-count-daily-frequency/event-count-daily-frequency-selectors';

import { selectEventCountFrequencyWidgetFilterValues } from 'services/event-count-frequency-widget/event-count-frequency-widget-selectors';
...
import { EventCountDailyFrequencyProperty, EventCountFrequencyWidgetProperty } from 'widgets';
import { EventCountDailyFrequency } from 'widgets/EventCount/EventCountDailyFrequency/Loadable';
import { EventCountFrequencyWidget } from 'widgets/EventCount/EventCountFrequencyWidget/Loadable';
...
import './FaultCountTrend.scss';

interface FaultCountTrendProps extends PageProps { }
...
export const FaultCountTrend: Page<FaultCountTrendProps> = memo((props: FaultCountTrendProps) => {
    ...
    const pageFilters = useMemo(() => {
        ...
        return [
            ...
            ...(EventCountFrequencyWidgetProperty.defaultFilters || []),
            ...(EventCountDailyFrequencyProperty.defaultFilters || []),
        ];
    }, []);
    ...
    return (
        <>
            <Helmet>
                <title>{t(messages.faultCountTrendPageTitle)}</title>
                <meta name="description" content="Description of FaultCountTrend" />
            </Helmet>
                ...
                <DashboardFilterPanel
                    ...
                    filterValues={() => {
                        const filterValues = [
                            ...
                            useSelector(selectEventCountDailyFrequencFilterValues),
                            // eslint-disable-next-line react-hooks/rules-of-hooks
                            useSelector(selectEventCountFrequencyWidgetFilterValues),
                        ].reduce((acc, filters) => {
                            acc = { ...acc, ...filters };
                            return acc;
                        }, {} as any);
            ...
            <div className={'x-cls-fault-count-trend-body x-cls-data-panel-container'}>
                ...
                >
                    ...
                    >
                        <EventCountFrequencyWidget
                            className="x-cls-event-count-frequency-widget"
                            filters={filters}
                    ...
                    >
                        <EventCountDailyFrequency
                            className="x-cls-event-desc-frequency"
                            filters={filters}
                            localFilters={localFilters}
                            onFilterChange={onFilterChange}
