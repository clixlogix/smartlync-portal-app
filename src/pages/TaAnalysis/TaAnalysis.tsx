...
import { selectTaAnalysisTableFilterValues } from 'services/ta-analysis-table/ta-analysis-table-selectors';
...
import { TaTable, TaTableProperty } from 'widgets/TaTable';
...
interface TaAnalysisProps extends PageProps { }
const listOfLocalFilters = [];

export const TaAnalysis: Page<TaAnalysisProps> = memo((props: TaAnalysisProps) => {
    ...
    const pageFilters = useMemo(() => {
        return [
            ...
            ...(TaTableProperty.defaultFilters || []),
        ];
    }, []);
    ...
    console.log(
        '🚀 ~ file: TaAnalysis.tsx ~ line 85 ~ constTaAnalysis:Page<TaAnalysisProps>=memo ~ apiFilters',
        apiFilters,
    );
    ...
    console.log('🚀 ~ file: TaAnalysis.tsx ~ line 90 ~ filters ~ filters', filters);
    ...
    return (
        <>
            <Helmet>
                <title>{t(messages.taAnalysisPageTitle)}</title>
                ...
                <DashboardFilterPanel
                    ...
                    filterValues={() => {
                        const filterValues = [
                            ...
                            useSelector(selectTaAnalysisTableFilterValues),
                        ].reduce((acc, filters) => {
                            acc = { ...acc, ...filters };
                            return acc;
                        }, {} as any);
