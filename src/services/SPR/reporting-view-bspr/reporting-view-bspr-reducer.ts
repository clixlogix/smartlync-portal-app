...
import { Filters, ReportingViewBsprs, ReportingDataView } from 'models';
import { ReportingViewBsprsState } from '.';
import moment from 'moment';

// The initial state of the ReportingViewBspr page
export const initialState: ReportingViewBsprsState = {
    faultCounts: [],
    faultReports: [],
 ...
 *
 */
const reportingViewBsprsSlice = createSlice({
    name: 'reportingViewBsprs',
    initialState,
    reducers: {
        getAllReportingViewBsprs(state, action: PayloadAction<Filters>) {
            state.filters = action.payload;
        },
        setAllReportingViewBsprs(state, action: PayloadAction<ReportingViewBsprs>) {
            // state.reportingViewBsprs = action.payload;
            ...
            let cnt = 0;
            const defaultTableValues = { cycleCount: 0, eventCount: 0, ripCount: 0, ropCount: 0 };
...
export const {
    actions: reportingViewBsprActions,
    reducer: reportingViewBsprReducer,
    name: reportingViewBsprKey,
} = reportingViewBsprsSlice;
