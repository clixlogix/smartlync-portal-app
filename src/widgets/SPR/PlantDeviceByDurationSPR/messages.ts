...
export const messages = {
    plantDeviceByDurationSprTitle: _t(
        translations.Widgets.PlantDeviceByDurationSpr.WidgetTitle,
        'PlantDeviceByDurationSpr widget',
    ), // default value
    plantDeviceByDurationSprSubTitle: _t(
        translations.Widgets.PlantDeviceByDurationSpr.SubTitle,
        'A plantDeviceByDurationSpr widget',
    ), // default value
