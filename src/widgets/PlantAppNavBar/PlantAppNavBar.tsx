...
// import './PlantAppNavBar.scss';
import { Box, Stack, Typography } from '@mui/material';

interface PlantAppNavBarProps extends WidgetProps {}

export const PlantAppNavBarWidget: Widget<PlantAppNavBarProps> = memo((props: PlantAppNavBarProps) => {
...
export const PlantAppNavBarProperty = Object.assign(
    {},
    {
...
export default PlantAppNavBarWidget;
