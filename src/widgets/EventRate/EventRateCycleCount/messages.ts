...
export const messages = {
    eventRateCycleCountitleWeekly: _t(
        translations.Widgets.EventRateCycleCount.EventRateCycleCountitleWeekly,
        'Cycle count By Week 2021',
    ),
    eventRateCycleCountitleDaily: _t(
        translations.Widgets.EventRateCycleCount.EventRateCycleCountitleDaily,
        'Cycle count By Day 2021',
    ),
    eventRateCycleCountChartTitleDaily: _t(
        translations.Widgets.EventRateCycleCount.EventRateCycleCountChartTitleDaily,
        'Cycle count and Event Percentage per Day {{yearLabel}}',
    ),
    eventRatePerEventChartTitleWeekly: _t(
        translations.Widgets.EventRateCycleCount.EventRateCycleCountWeekly,
        'Cycle count and Event Percentage per Week {{yearLabel}}',
    ),
