...
export const messages = {
    cycleGapTitle: _t(translations.CyclegapTempoSpr.PageTitle, 'CycleGap widget'),
    ...
    actualCurve: _t(translations.CyclegapTempoSpr.ActualCurve, 'ActualCurve'),
    referenceCurve: _t(translations.CyclegapTempoSpr.ReferenceCurve, 'referenceCurve'),
};
